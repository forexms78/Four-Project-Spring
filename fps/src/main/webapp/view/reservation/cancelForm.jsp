...
<!-- 예약 취소 폼입니다 -->
	<form action="cancel" name="f" method="post">
		...
		<table width="600" cellpadding="5" cellspacing="2" border="0"
			align="center">
			...
			<tr>
				<td colspan="2" align="center">위 예약을 취소합니까?</td>
			</tr>
			<tr>
				<td colspan="1" align="center"><input class="w3-button w3-black" type="submit" value="예약 취소하기"></td>
			</tr>
